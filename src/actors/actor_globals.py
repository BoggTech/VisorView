...
SELLBOTS = [
    ...
    CogActor("Telemarketer", "sell", "b", 3.75 / B_SIZE, SELL_HANDS, head_nodes="**/telemarketer", ),
    CogActor("Name Dropper", "sell", "a", 4.35 / A_SIZE, SELL_HANDS, head_nodes="**/numbercruncher", head_texture=HEAD_PREFIX_4 + "name-dropper.jpg"),
    CogActor("Glad Hander", "sell", "c", 4.75 / C_SIZE, SELL_HANDS, head_nodes="**/gladhander", ),
...
CASHBOTS = [
    CogActor('Short Change', 'cash', 'c', 3.6 / C_SIZE, CASH_HANDS, head_nodes='**/coldcaller'),
    CogActor('Penny Pincher', 'cash', 'a', 3.55 / A_SIZE, VBase4(1.0, 0.5, 0.6, 1.0), head_nodes='**/pennypincher'),
    CogActor('Tightwad', 'cash', 'c', 4.5 / C_SIZE, CASH_HANDS, head_nodes='**/tightwad'),
    CogActor('Bean Counter', 'cash', 'b', 4.4 / B_SIZE, CASH_HANDS, head_nodes='**/beancounter'),
...
LAWBOTS = [
    CogActor('Bottom Feeder', 'law', 'c', 4.0 / C_SIZE, LAW_HANDS, head_nodes='**/tightwad', head_texture=HEAD_PREFIX_3_5 + 'bottom-feeder.jpg'),
    ...
    CogActor('Double Talker', 'law', 'a', 4.25 / A_SIZE, LAW_HANDS, head_nodes='**/twoface', head_texture=HEAD_PREFIX_4 + 'double-talker.jpg'),
    CogActor('Ambulance Chaser', 'law', 'b', 4.35 / B_SIZE, LAW_HANDS, head_nodes='**/ambulancechaser'),
...
BOSSBOTS = [
    CogActor('Flunky', 'boss', 'c', 4.0 / C_SIZE, BOSS_HANDS, head_nodes=["**/flunky", "**/glasses"]),
    CogActor('Pencil Pusher', 'boss', 'b', 3.35 / B_SIZE, BOSS_HANDS, head_nodes='**/pencilpusher'),
    CogActor('Yesman', 'boss', 'a', 4.125 / A_SIZE, BOSS_HANDS, head_nodes='**/yesman'),
    CogActor('Micromanager', 'boss', 'c', 2.5 / C_SIZE, BOSS_HANDS, head_nodes='**/micromanager'),
