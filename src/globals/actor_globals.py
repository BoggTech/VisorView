...
SUPERVISORS = [
    CogActorData("Factory Foreman (Neutral)", "sell", "b", 6.05 / B_SIZE, (0.886, 0.737, 0.784, 1.0), head_nodes="**/factoryforeman", is_supervisor=True),
    CogActorData("Factory Foreman (Angry)", "sell", "b", 6.05 / B_SIZE, (0.886, 0.737, 0.784, 1.0), head_nodes="**/factoryforemanangry", is_supervisor=True),
